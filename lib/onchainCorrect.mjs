...
//    Lifetime: 339 failed buys, 89 failed sells, 18 failed claims - 428 failed
//    attempts rendered as trades, "12,408 trades" against 11,980. Measured end
//    to end by the full-history count, which matched on every complete day once
//    the chain snapshot's one missing battle was filled (wavewarz-protocol #11).
//
