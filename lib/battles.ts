...
// (snapshot 2026-07-24T04:37Z). Feed in public/ww-battles.json; run
...
// Source: GET https://wavewarz.info/api/public/stats (2026-07-24T04:37Z)
// battles: { total:1289, mainEvents:51, mainBattles:165, quickBattles:1088, communityBattles:36 }
...
export const BATTLE_STATS = {
  ...
  communityBattles: 36,
  totalShown: 1289,     // total per live API (feed lags by ~141 battles)
  totalVolumeSol: 878.30,
  artistPayoutsSol: 13.3951,
  platformRevenueSol: 20.0361,
