...
// (snapshot 2026-07-26T11:43Z). Feed in public/ww-battles.json; run
...
// Source: GET https://wavewarz.info/api/public/stats (2026-07-26T11:43Z)
// battles: { total:1291, mainEvents:51, mainBattles:165, quickBattles:1090, communityBattles:36 }
...
export const BATTLE_STATS = {
  ...
  communityBattles: 36,
  totalShown: 1291,     // total per live API (feed lags)
  totalVolumeSol: 878.1237,
  artistPayoutsSol: 13.3921,
  platformRevenueSol: 20.0587,
