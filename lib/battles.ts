...
// Source: GET https://wavewarz.info/api/public/stats  (2026-07-17T06:48Z)
// battles: { total:1245, mainEvents:50, mainBattles:162, quickBattles:1047, communityBattles:36 }
...
export const BATTLE_STATS = {
  ...
  communityBattles: 36,
  totalShown: 1245,
  totalVolumeSol: 522.23,
  artistPayoutsSol: 9.05,
  platformRevenueSol: 17.43,
...
export const RECENT_BATTLES: RecentBattle[] = [
  ...
  { type: "QUICK", a: "Never Need", b: "DREAM TIL' YOU DIE", winner: "DREAM TIL' YOU DIE", vol: 0.1477, date: "Jul 17, 2026" },
];
