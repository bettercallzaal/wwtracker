...
//
// battle_id: numeric ID (0-based) from the program (check ww-battles.json for context)
//
...
//
// Account layout source: docs/WAVEWARZ-RESEARCH.md §3 (not the full IDL — struct
// field order is estimated from Anchor convention and may need adjustment if the
// private IDL diverges. The discriminator is verified on-chain).
