...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    n: "08",
    title: "The music",
    intro: "the songs and artists behind the battles — charting tracks, Audius plays, song arena rankings, and complete battle records for every track that has fought 3+ times.",
    render: () => (
      <>
        <Songs />
        <div style={{ height: 24 }} />
