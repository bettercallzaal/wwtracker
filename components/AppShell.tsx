...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    n: "06",
    title: "The battles",
    intro: "every battle on record. search it, sort it, export it — plus handle rankings, rivalries, the biggest vol days, artist earnings, and the last 30 days of form.",
    render: () => (
      <>
        <Battles />
        <div style={{ height: 24 }} />
