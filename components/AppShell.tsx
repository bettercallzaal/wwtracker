...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    intro: "where WaveWarZ sits in the bigger picture - the ZAO DAO vitals, Fractal governance, the creative IP catalog, community channels, events, and the questions people ask most.",
    render: () => (
      <>
        <ZaoVitals />
        <div style={{ height: 24 }} />
